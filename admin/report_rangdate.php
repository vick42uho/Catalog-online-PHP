<form action="" method="get" class=" form-horizontal">
    ...
    <div class="row">
        <tr>
            ...
            <th>
                <div class=" col-sm-3"><button type="submit" class="btn btn-primary" name="act" value="rangdate">ค้นหา</button></div>
            </th>
...
$query = "SELECT 
            ...
            DATE_FORMAT(o_dttm, '%Y-%m-%d') AS o_dttm
        FROM order_head
...
<p>
        วันที่เริ่มต้น : 
        <font color="blue"><?php echo date('d/m/Y', strtotime($ds)) ?></font>
    
        ถึงวันที่ : 
        <font color="blue"><?php echo date('d/m/Y', strtotime($de)) ?></font>
</p>
