        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <?php if (empty($rowdetail['o_ems'])) : ?>
                            เลข EMS : <font color="orange">รอเลขพัสดุ...</font>
                        <?php else : ?>
                            เลข EMS : <font color="blue"><?php echo $rowdetail['o_ems']; ?></font>
                        <?php endif; ?>
                        <br>
                        <?php if ($rowdetail['o_ems_date'] == "0000-00-00 00:00:00"): ?>
                            วันที่ : <font color="orange">รอเลขพัสดุ...</font>
                        <?php else : ?>
                            วันที่ : <?php echo $rowdetail['o_ems_date']; ?>
                        <?php endif; ?>
                    </div>
